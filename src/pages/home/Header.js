            ...
            <div className="header-bottom">
                ...
                <div className="flex-container">
                    ...
                    <Grid className="welcome-grid" item xs={12} sm={6}>
                        ...
                        <p>Since the inception of Sahodaya MMR and OMMR in 2009, to the present day, various efforts have been made to provide the right type of guidance and opportunities to all the schools associated with the complex in Mumbai, Thane (incl. Navi Mumbai), Palghar and Raigad Districts. Regular meetings and workshops are conducted to ensure an exchange of information and ideas, 
